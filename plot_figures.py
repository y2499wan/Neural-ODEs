...
names = ['experiment_node_cifar_v', 'experiment_sonode_conv_cifar_v', 'experiment_anode_cifar_v']
...
plt.ylim(0.05, 0.99)
plt.title('CIFAR Training Accuracy', fontsize=22)
...
plt.ylim(0.05, 0.99)
plt.title('CIFAR Test Accuracy', fontsize=22)
...
plt.ylim(10, 50)
plt.title('CIFAR NFE', fontsize=22)
