...
python anode.py --extra_channels 10 --save './experiment_anode10_mnist_v1' --dataset mnist
python anode.py --extra_channels 10 --save './experiment_anode10_mnist_v2' --dataset mnist
python anode.py --extra_channels 10 --save './experiment_anode10_mnist_v3' --dataset mnist
