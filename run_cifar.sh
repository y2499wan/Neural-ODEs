...
python anode.py --extra_channels 1 --save'./experiment_anode_cifar_v1'
python anode.py --extra_channels 1 --save'./experiment_anode_cifar_v2'
python anode.py --extra_channels 1 --save'./experiment_anode_cifar_v3'
